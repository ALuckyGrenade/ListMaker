...
class MainActivity : AppCompatActivity(),
    ...
    // variables used with xlarge content_main (tablets)
    ...
    // Runs when the user presses the main FAB
    ...
    // Runs when the user presses the FAB in a list item
    ...
    // Runs when the back button is pressed in a fragment
